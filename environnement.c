...
erreur_terrain initialise_environnement(Environnement *envt,
  ...
  init_robot(&(envt->r), x, y, Est);
   ...
   envt->etat_courant=etat_initale();
...
resultat_deplacement avancer_envt(Environnement *envt) {
  ...
  position_devant(&(envt->r), &x, &y);
   ...
   envt->etat_courant=transition(envt->etat_courant,A);
...
void gauche_envt(Environnement *envt) {
   ...
   envt->etat_courant=transition(envt->etat_courant,G);
}
...
envt->etat_courant=transition(envt->etat_courant,D);
}
...
int mesure_envt(Environnement *envt, int d) {
  ...
  position(&(envt->r), &x, &y);
   ...
   envt->etat_courant=transition(envt->etat_courant,M);
