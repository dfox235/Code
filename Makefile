...
PROGRAMMES=test_terrain test_robot robot_terrain curiosity curiosity-test curiosity-obs
...
interprete%.o: interprete%.c interprete.h environnement.h  \
	programme.h type_pile.h robot.h terrain.hc observateur.h
...
curiosity-perf.o: curiosity-perf.c generation_terrains.h environnement.h programme.h\
	terrain.h interprete.h
...
curiosity-perf: curiosity-perf.o generation_terrains.o\
	terrain.o environnement.o robot.o interprete.o programme.o type_pile.o
		$(CC) $^ -o $@
